...
└── Questões Prova Paulista de Matematica do 1º Bimestre de 2026/      
    └──  1-serie-dia-2-prova-roxa-1-16.pdf                                  # Base de informações para a criação
    └──  Prova_e_Folha_de_Respostas_Seduc_1_srie_DIA_2__Prova_Roxa-2-5.pdf  # Base de informações para a criação
```
